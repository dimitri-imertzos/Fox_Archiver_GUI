...
function mbstowcs(pwcs: PWideChar; const s: PWideChar; n: size_t)
  : size_t; cdecl;
...
function _open(const __path: PAnsiChar; __access: Integer;
  __permission: Integer): Integer; cdecl;
{$EXTERNALSYM _open}
function _wopen(const __path: PChar; __access: Integer; __permission: Integer)
  : Integer; cdecl;
{$EXTERNALSYM _wopen}
function _close(__handle: Integer): Integer; cdecl;
{$EXTERNALSYM _close}
function _lseek(__handle: Integer; __offset: Integer; __fromwhere: Integer)
  : Integer; cdecl;
{$EXTERNALSYM _lseek}
function _read(__handle: Integer; __buf: Pointer; __len: LongWord)
  : Integer; cdecl;
{$EXTERNALSYM _read}
function _write(__handle: Integer; __buf: Pointer; __len: LongWord)
  : Integer; cdecl;
{$EXTERNALSYM _write}
function open(const __path: PAnsiChar; __access: Integer; __permission: Integer)
  : Integer; cdecl;
{$EXTERNALSYM open}
function close(__handle: Integer): Integer; cdecl;
{$EXTERNALSYM close}
function lseek(__handle: Integer; __offset: Integer; __fromwhere: Integer)
  : Integer; cdecl;
{$EXTERNALSYM lseek}
function read(__handle: Integer; __buf: Pointer; __len: LongWord)
  : Integer; cdecl;
{$EXTERNALSYM read}
function write(__handle: Integer; __buf: Pointer; __len: LongWord)
  : Integer; cdecl;
{$EXTERNALSYM write}
...
{$EXTERNALSYM printf}
function fprintf(fHandle: Pointer; format: PAnsiChar { args } ): Integer;
  cdecl; varargs;
{$EXTERNALSYM fprintf}
function sprintf(buf: Pointer; format: PAnsiChar { args } ): Integer;
  cdecl; varargs;
{$EXTERNALSYM sprintf}
function snprintf(buf: Pointer; nzize: size_t; format: PAnsiChar;
  param: va_list): Integer; cdecl;
{$EXTERNALSYM snprintf}
function _snprintf(buf: Pointer; nzize: size_t; format: PAnsiChar;
  param: va_list): Integer; cdecl;
{$EXTERNALSYM _snprintf}
function vsnprintf(buf: Pointer; nzize: size_t; format: PAnsiChar;
  param: va_list): Integer; cdecl;
{$EXTERNALSYM vsnprintf}
function _vsnprintf(buf: Pointer; nzize: size_t; format: PAnsiChar;
  param: va_list): Integer; cdecl;
...
function _itoa(value: Integer; str: PAnsiChar; radix: Integer)
  : PAnsiChar; cdecl;
{$EXTERNALSYM _itoa}
function itoa(value: Integer; str: PAnsiChar; radix: Integer): PAnsiChar; cdecl;
{$EXTERNALSYM itoa}
function _i64toa(value: Int64; str: PAnsiChar; radix: Integer)
  : PAnsiChar; cdecl;
{$EXTERNALSYM _i64toa}
...
{$EXTERNALSYM strtod}
function gcvt(value: Double; digits: Integer; buffer: PAnsiChar)
  : PAnsiChar; cdecl;
{$EXTERNALSYM gcvt}
function _gcvt(value: Double; digits: Integer; buffer: PAnsiChar)
  : PAnsiChar; cdecl;
{$EXTERNALSYM _gcvt}
...
function _lseeki64(__handle: Integer; __offset: Int64; __fromwhere: Integer)
  : Int64; cdecl;
...
{$EXTERNALSYM _llushr}
{$ENDIF WIN32}
procedure qsort(baseP: PByte; NElem, Width: size_t;
  comparF: qsort_compare_func); cdecl;
{$EXTERNALSYM qsort}
...
function _beginthreadex(security_attr: Pointer; stksize: LongWord;
  start: Pointer; arg: Pointer; create_flags: LongWord; var thread_id: LongWord)
  : LongWord; cdecl;
...
var
  ___favor, ___isa_available, ___isa_enabled: Cardinal;
...
begin
  if cookie = __security_cookie then
    exit;
...
procedure __mbctype; external msvcrt name '_mbctype';
// Not a function, pointer to data
...
procedure CallCPUID(ValueEAX, ValueECX: Cardinal; var ReturnedEAX, ReturnedEBX,
...
var
  EAX, EBX, ECX, EDX, H: Cardinal;
  CpuName: array [0 .. 47] of ansichar;

type
  TTT = array [0 .. 7] of byte;
...
{$ENDIF}
    ...
    else if EDX and $4000000 > 0 then
    begin // Check SSE2
{$IFDEF CPU32BITS}
      ___isa_available := 1;
      ___isa_enabled := 3;
...
{$ENDIF}
    ...
    if H >= $80000003 then
      CallCPUID($80000003, 0, CpuName[16], CpuName[20], CpuName[24],
        CpuName[28]);
    if H >= $80000004 then
      CallCPUID($80000004, 0, CpuName[32], CpuName[36], CpuName[40],
        CpuName[44]);
    Name := CpuName;
    if Name.toupper.IndexOf('ATOM') >= 0 then
    begin
{$IFDEF CPU32BITS}
